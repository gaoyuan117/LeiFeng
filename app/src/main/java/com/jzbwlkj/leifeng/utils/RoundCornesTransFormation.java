...
public class RoundCornesTransFormation implements Transformation<Bitmap> {
    ...
    public RoundCornesTransFormation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundCornesTransFormation(BitmapPool pool, int radius, int margin) {

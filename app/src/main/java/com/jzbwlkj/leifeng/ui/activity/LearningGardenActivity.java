...
public class LearningGardenActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    public void initView() {
        ...
        adapter = new LearningGardenAdapter(R.layout.item_news, mList);

 ...
 */
public class MyProFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private void getNetData(){
        RetrofitClient.getInstance().createApi().userProList(BaseApp.token,0)
